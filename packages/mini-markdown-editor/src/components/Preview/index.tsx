...
import { parseMarkdown, transformHtml } from "@mini-markdown-resin/ast-parser";
...
const Preview: FC<{ content: string; isSyncScroll: boolean }> = ({
  content,
  isSyncScroll,
}) => {
  const { scrollWrapper, setScrollWrapper, setPreviewView, editorView } =
